...
def spectral_label_overlap_double_hash(
    biadjacency,
    num_users_c,
    num_items_c,
    resolution=1.0,
    ...
    for t in range(n_iter):
        ...
        #         y = adj.indices[i]
        #         value = adj.data[i] - resolution * deg[x] * deg[y] / sum_edge
        #         l = labels[y]
        #         prob_labels[l] += value
        #         label_set.add(l)
        #
        ...
        #         if prob_labels[label_target] > max_value:
        #             max_value = prob_labels[label_target]
